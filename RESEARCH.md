...
> Fork：https://github.com/KevPH2026/Clypra
...
Fork：   github.com/KevPH2026/Clypra
...
**言剪（待定名）的机会窗口：** 剪映强在「手动剪」，Descript 强在「文本驱动编辑」，但 **没有人做「Agent 驱动编辑」**——你说一段话，AI 理解意图，自动完成剪辑全流程。这是 Clypra 架构的最佳魔改方向。
