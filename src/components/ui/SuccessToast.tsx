...
const variantConfig: Record<ToastVariant, { labelKey: string; iconPath: string; accentVar: string; iconColor: string; glowClass: string; barClass: string; bgClass: string; borderClass: string }> = {
  success: {
    labelKey: "general.success",
