...
export const TransformSection: React.FC<TransformSectionProps> = ({ selectedClip, isVisualClip, handleUpdate, handleApplyFit }) => {
  return (
    <div className="space-y-6">
      ...
      <div>
        <h4 className="text-sm font-semibold text-text-primary mb-3">{t("properties.transform")}</h4>
        <div className="space-y-2">
          {isVisualClip && (
            <div className="grid grid-cols-2 gap-2">
              <div>
                <label className="text-xs text-text-muted block mb-1">{t("properties.fitMode")}</label>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="text-xs text-text-muted block mb-1">{t("properties.xPosition")}</label>
            ...
            <div>
              <label className="text-xs text-text-muted block mb-1">{t("properties.yPosition")}</label>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="text-xs text-text-muted block mb-1">{t("properties.width")}</label>
            ...
            <div>
              <label className="text-xs text-text-muted block mb-1">{t("properties.height")}</label>
          ...
          <div>
            <label className="text-xs text-text-muted block mb-1">{t("properties.rotation")}</label>
          ...
          <div>
            <label className="text-xs text-text-muted block mb-1">{t("properties.opacity")}</label>
            <div className="flex items-center gap-2">
      ...
      <div className="border-t border-border/40 pt-4">
        <div className="mb-3">
          <h4 className="text-sm font-semibold text-text-primary">{t("properties.timingOptions")}</h4>
        </div>
        <div className="space-y-3">
          <div>
            <label className="text-xs text-text-muted block mb-1">{t("properties.trimIn")}</label>
          ...
          <div>
            <label className="text-xs text-text-muted block mb-1">{t("properties.trimOut")}</label>
